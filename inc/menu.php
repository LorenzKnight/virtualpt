...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="inicio.php">
        ...
        <div class="sidebar-brand-text mx-3">Virtual PT <!--<sup>2</sup>--></div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Specialized PT:</h6>
            <a class="collapse-item" href="pers_trainers_bb.php">Bodybuilders</a>
            <a class="collapse-item" href="pers_trainers_ftn.php">Fitness</a>
            <a class="collapse-item" href="pers_trainers_d.php">Dietitian</a>
          </div>
        </div>
      </li>
