...
<body>
    <div class="wrapper">
            ...
            <div class="head">
                ...
                <div class="col_2">
                    <div class="formular_front">
                        <form action="login.php" method="post" name="forminsert" id="forminsert">
                            <table width="70%" align="center" cellspacing="0" class="list">
                                ...
                                <tr valign="baseline">
                                    <td style=" padding-bottom:10px;" nowrap="nowrap" align="center"><input style="padding: 20px 170px;" type="submit" class="button" value="LOGING" /></td>
                                </tr>
                                <tr valign="baseline">
                                    <td style=" padding-bottom:10px;" nowrap="nowrap" align="center">
                                        Do not have an account in Virtual PT?<br><br>
        ...
        <?php include("inc/foot_inicio.php"); ?>
    </div>
</body>
</html>
